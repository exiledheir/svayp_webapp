...
const en: Translations = {
  ...
  cv_bt_offer_all: 'All as shop photos',
  cl_items_n: '{n} items',
  ...
  cv_rv_delete: 'Delete',
  cv_rv_beautify_banner: 'Not happy with a photo? Make it look like the shop.',
  ...
  cv_bt_button: 'Shop photo',
  cv_bt_title: 'Which one looks better?',
  cv_bt_subtitle: 'You choose what we keep',
  cv_bt_original: 'Original photo',
  cv_bt_beautified: 'Shop photo',
  cv_bt_save: 'Keep the shop photo',
  cv_bt_keep: 'Keep original photo',
  cv_bt_working: 'Making a shop photo…',
  cv_bt_ready: 'Beautified version ready — tap to compare',
  cv_bt_failed: "That didn't work — try again",
  cv_bt_soon: 'Shop photos are coming soon',
  cv_dt_original: 'Original',
  cv_dt_beautified: 'Shop photo',
  cv_dt_color: 'Colour',
  cv_dt_season: 'Season',
  ...
  cv_bt_intro_title: 'A shop photo of your own clothes',
  cv_bt_intro_body: "We remove the background and lay your piece out the way shops photograph theirs. You'll see both versions and choose which to keep.",
  cv_bt_intro_cta: 'Got it',
  cv_bt_auto_kicker: 'Shop photo',
  cv_bt_auto_headline: "We'll clean up your photos automatically",
  cv_bt_intro_caption: 'Removes the background and lays your piece out the way shops photograph theirs.',
  cv_bt_intro_which: 'These photos will be redone — {n} selected',
  cv_bt_intro_do: 'Make it a shop photo',
  cv_bt_intro_skip: 'Maybe later',
  cv_bt_intro_skip_add: 'Add without changing',
  ...
  outfitsExhaustedTitle: 'No new outfits left',
  outfitsExhaustedBody: 'You have seen all AI outfits for your wardrobe. Add new clothes to get fresh combinations!',
...
const ru: Translations = {
  ...
  cn_title: 'Алмазы',
  cn_have: 'У вас {n}',
  cn_need_more: 'Недостаточно алмазов — пополните, чтобы продолжить.',
  cn_pack_title: 'Купить алмазы',
  cn_off: '−{n}%',
  cn_custom: 'Или введите своё количество',
  cn_custom_ph: 'Количество алмазов',
  cn_total: 'Итого',
  cn_hint_next: 'Добавьте ещё {n} и получите −30%',
  cn_warn: 'Результат генерации не возвращается — каждый запуск списывает алмазы.',
  cn_survey: 'Иногда алмазы можно получить за прохождение опросов.',
  ...
  pay_success_coins: 'Начислено {n} алмазов',
  ...
  cv_bt_offer_all: 'Все как в магазине',
  cl_items_n: '{n} вещей',
  ...
  cv_rv_beautify_banner: 'Не нравится фото? Сделайте его как в магазине.',
  ...
  cv_bt_intro_title: 'Ваша вещь — как в магазине',
  cv_bt_intro_body: 'Убираем фон и раскладываем вещь так, как её снимают в магазине. Покажем оба варианта — вы решаете, какой оставить.',
  cv_bt_intro_cta: 'Понятно',
  cv_bt_auto_kicker: 'Фото как в магазине',
  cv_bt_auto_headline: 'Мы автоматически улучшим ваши фото',
  cv_bt_intro_caption: 'Убирает фон и раскладывает вещь так, как её снимают в магазине.',
  cv_bt_intro_which: 'Переснимем эти фото — выбрано {n}',
  cv_bt_intro_do: 'Сделать как в магазине',
  cv_bt_intro_skip: 'Позже',
  cv_bt_intro_skip_add: 'Добавить как есть',
  ...
  outfitsExhaustedTitle: 'Образы закончились',
  outfitsExhaustedBody: 'Вы посмотрели все образы от ИИ для вашего гардероба. Добавьте новую одежду, чтобы получить свежие сочетания!',
...
const uz: Translations = {
  ...
  cn_title: 'Olmoslar',
  cn_have: 'Sizda {n} ta',
  cn_need_more: 'Olmoslar yetarli emas — davom etish uchun to‘ldiring.',
  cn_pack_title: 'Olmos sotib olish',
  cn_off: '−{n}%',
  cn_custom: 'Yoki o‘z miqdoringizni kiriting',
  cn_custom_ph: 'Olmoslar soni',
  cn_total: 'Jami',
  cn_hint_next: 'Yana {n} ta qo‘shing va −30% oling',
  cn_warn: 'Natija qaytarilmaydi — har bir ishga tushirish olmos sarflaydi.',
  cn_survey: 'Ba’zan so‘rovnomalar orqali olmos topishingiz mumkin.',
  ...
  pay_success_coins: '{n} ta olmos qo\'shildi',
  ...
  cv_bt_offer_all: "Hammasini do'kondagidek qilish",
  ...
  cv_rv_beautify_banner: "Surat yoqmadimi? Uni do'kondagidek qiling.",
  ...
  cv_bt_intro_title: "Kiyimingiz — do'kondagidek",
  cv_bt_intro_body: "Fonni olib tashlaymiz va kiyimni do'konlarda suratga olinganidek joylashtiramiz. Ikkala variantni ko'rsatamiz — qaysi birini qoldirishni o'zingiz hal qilasiz.",
  cv_bt_intro_cta: 'Tushunarli',
  cv_bt_auto_kicker: "Do'kondagidek surat",
  cv_bt_auto_headline: 'Suratlaringizni avtomatik tozalaymiz',
  cv_bt_intro_caption: "Fonni olib tashlaydi va kiyimni do'konlarda suratga olinganidek joylashtiradi.",
  cv_bt_intro_which: "Bu suratlar qayta tayyorlanadi — {n} ta tanlandi",
  cv_bt_intro_do: "Do'kondagidek qilish",
  cv_bt_intro_skip: 'Keyinroq',
  cv_bt_intro_skip_add: "O'zgartirmasdan qo'shish",
  ...
  outfitsExhaustedTitle: "Obrazlar tugadi",
  outfitsExhaustedBody: "Garderobingiz uchun barcha AI obrazlarini ko'rdingiz. Yangi kombinatsiyalar uchun yangi kiyim qo'shing!",
