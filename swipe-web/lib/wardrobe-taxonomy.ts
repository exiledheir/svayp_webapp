...
const LABELS_EN: LabelMap = {
  ...
  BAGS: 'Bags', HEADSCARF_HIJAB: 'Headscarf / Hijab', SCARF: 'Scarf', GLASSES: 'Glasses', HEADWEAR: 'Headwear', JEWELRY: 'Jewelry', BELT: 'Belt',
  // itemTypes
...
const LABELS_RU: LabelMap = {
  ...
  BAGS: 'Сумка', HEADSCARF_HIJAB: 'Платок/Хиджаб', SCARF: 'Шарф', GLASSES: 'Очки', HEADWEAR: 'Головной убор', JEWELRY: 'Украшения', BELT: 'Ремень',
...
const LABELS_UZ: LabelMap = {
  ...
  BAGS: 'Sumka', HEADSCARF_HIJAB: 'Roʻmol/Hijob', SCARF: 'Sharf', GLASSES: 'Koʻzoynak', HEADWEAR: 'Bosh kiyim', JEWELRY: 'Taqinchoqlar', BELT: 'Kamar',
